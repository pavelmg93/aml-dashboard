...
The provided dashboard link is a **Master Template**. To visualize the data generated by your specific pipeline run, you must clone the template and connect it to your BigQuery dataset.

### 1. Access the Template
Click the link provided by `make dc-dashboard` or use the URL below:
[**AML Dashboard Template**](https://datastudio.google.com/u/1/reporting/78f521cd-3007-4151-9cd3-fe4a107d4e8c/page/VdnvF)

### 2. Create Your Copy
* In the top right corner of the Looker Studio interface, click the **three-dot menu (More options)** and select **Make a copy**.
* A dialog box will appear titled "Copy this report."

### 3. Connect Your BigQuery Data
* Click the dropdown for the **New Data Source** and select **Create data source**.
* Select the **BigQuery** connector.
* Navigate to your **Project ID** -> **Dataset Name** (e.g., `aml_bq2`) -> **all_transactions**.
* Click **Connect** in the top right, then click **Add To Report**.
* Confirm by clicking **Copy Report**.
